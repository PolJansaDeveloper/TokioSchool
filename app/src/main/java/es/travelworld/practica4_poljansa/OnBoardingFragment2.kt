...
import es.travelworld.practica4_poljansa.databinding.FragmentOnBoarding2Binding
...
class OnBoardingFragment2 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener(){
            try {
                findNavController().navigate(R.id.fragment2_to_loginfragment)
            }catch (e:Exception){
                Log.e("Navigation Error", "Error al navegar",e)
            }
        }
